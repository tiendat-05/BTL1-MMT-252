...
This module launches Peer 2 instance for P2P network communication.
Peer 2 listens on port 9003 by default and connects to the Tracker server.
"""
...
PEER_NAME = "peer2"
PEER_PORT = 9003  # Default port for Peer 2
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        prog='Peer2',
        description='P2P Peer 2 - Communicates via Tracker',
